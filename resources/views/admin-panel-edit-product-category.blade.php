                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="/adm/products-categories/{{ $productCategory->id }}/update" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="card-body card-block">
                                    <label class=" form-control-label">Imagenes</label>

                                    @if (count($productCategory->picture))
                                        <ul class="img-producto-form">
                                            <li>
                                                <img src="/uploads/productsCategories/tumb/{{ $productCategory->picture->picture }}" alt="">
                                            </li>
                                        </ul>
                                    @endif
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input id="input-b1" type="file" class="file" name="pictures[]" data-theme="fas"  @if (!$productCategory->picture->picture) {{ "required" }} @endif>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" name="name" placeholder="Nombre del proyecto *" value="{{ $productCategory->name }}" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                            <textarea class="form-control" name="description" required>{{ $productCategory->description }}</textarea>
                                        </div>
