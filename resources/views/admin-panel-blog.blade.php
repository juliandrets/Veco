            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-12" style="padding-bottom: 20px">
                        <a href="/adm/blog/create"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Nueva Noticia</button></a>
                    </div>
                                ...
                                <ul id="sliders">
                                    @foreach($blogs as $blog)
                                        <li>
                                            ...
                                            <ul>
                                                <li><a href="/adm/blog/{{ $blog->id }}/edit"><i class="fa fa-pencil edit" aria-hidden="true"></i></a></li>
                                                <li><a href="/adm/blog/{{ $blog->id }}/delete" onclick="return deleteConfirm()"><i class="fa fa-close delete" aria-hidden="true"></i></a></li>
                                            </ul>
                                        </li>
                                    @endforeach
                                </ul>
