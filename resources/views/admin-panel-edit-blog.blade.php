                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active"><a href="#">Editar noticia</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="/adm/blog/{{ $blog->id }}/update" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="card-body card-block">
                                    <div class="form-group">
                                        <label class=" form-control-label">Imagenes</label>

                                        @if (count($blog->pictures))
                                            <ul class="img-producto-form">
                                                @foreach ($blog->pictures as $picture)
                                                    <li>
                                                        <img src="/uploads/blog/tumb/{{ $picture->picture }}" alt="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" name="name" value="{{ $blog->name }}" placeholder="Nombre del proyecto *" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                            <textarea class="form-control" name="description" required maxlength="255">{{ $blog->description }}</textarea>
                                        </div>
